...
func (acctRec *AcctRec) ToAccountviewDataPostRequest(client *Client) (AccountviewDataPostRequest, error) {
	return BusinessObjectToAccountviewDataPostRequest(client, acctRec, nil)
}
...
type Contact struct {
	...
	L5MinOrd   float64  `json:"L5_MINORD"`  // L5-minimumorderbedrag
	...
	LstBank    string   `json:"LST_BANK"`
	LstMem     string   `json:"LST_MEM"`
	LstPchs    string   `json:"LST_PCHS"`
	LstSales   string   `json:"LST_SALES"`
	...
	X15B0UL4GI string   `json:"X15B0UL4GI"`
	X15B0UONIQ string   `json:"X15B0UONIQ"`
	X15B0UU74X string   `json:"X15B0UU74X"`
	E1Branch   string   `json:"E1BRANCHE"`
	E1Bron     string   `json:"E1BRON"`
